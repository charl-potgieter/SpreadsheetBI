...
'
' All of the narrative and textual content on this site, unless stated otherwise, is
'© Copyright 1997 - 2013 by Charles H. Pearson. All of the formulas and VBA code are explicitly
'granted to the Public Domain. You may use the formulas and VBA code on this site for any purpose you see
'fit without permission from me. This includes inclusion in commercial works and works for hire.
'By using the formula and code on this site, you agree to hold Charles H. Pearson and Pearson Software
'Consulting, LLC, free of any liability. The formulas and code are presented as is and the author makes no
'warranty, express or implied, of their fitness for use. You assume all responsibility for testing and
'ensuring that the code works properly in your environment.
'
'The following may be trademarks or registered trademarks of Microsoft Corporation:
'Windows, Windows XP, Windows Vista, Vista, Windows 7, Excel, Word, Access, PowerPoint,
'FrontPage, Office, Visio, Visual Basic, VBNET, C#, and Visual Basic For Applications.
'Any trademarks that appear on this site are the property of their respective owners.
'
'Microsoft is not affiliated in any way with this web site or its content. The Most Valuable
'Professional (MVP) award and the use of the MVP logo do not constitute any endorsement of any kind
'by Microsoft.
'
'If you use any of the formula or code on this web site, I would appreciate that you put a reference to this site and/or the specific page in the code and/or in the related documentation.
'
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
